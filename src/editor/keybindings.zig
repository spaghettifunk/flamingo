...
test "legacy keybinding defaults have registry entries" {
    const config = @import("../config.zig");
    const keys = config.KeybindingsConfig{};
    const cases = [_]struct {
        context: BindingContext,
        key_text: []const u8,
        command: commands.CommandId,
    }{
        .{ .context = .dashboard, .key_text = keys.new_file, .command = .dashboard_new_file },
        .{ .context = .dashboard, .key_text = keys.open_file, .command = .dashboard_open_file },
        .{ .context = .dashboard, .key_text = keys.open_folder, .command = .dashboard_open_folder },
        .{ .context = .dashboard, .key_text = keys.settings, .command = .dashboard_settings },
        .{ .context = .global, .key_text = keys.quit, .command = .app_quit_flamingo },
        .{ .context = .dashboard, .key_text = keys.quit, .command = .app_quit_flamingo },
        .{ .context = .global, .key_text = keys.toggle_explorer, .command = .explorer_toggle },
        .{ .context = .global, .key_text = keys.toggle_terminal, .command = .terminal_toggle },
        .{ .context = .global, .key_text = keys.switch_focus, .command = .app_cycle_panel_focus },
        .{ .context = .global, .key_text = keys.close_tab, .command = .app_close_tab },
        .{ .context = .global, .key_text = keys.next_tab, .command = .app_next_tab },
        .{ .context = .global, .key_text = keys.previous_tab, .command = .app_previous_tab },
        .{ .context = .normal, .key_text = keys.jump_back, .command = .navigation_jump_back },
        .{ .context = .normal, .key_text = keys.jump_forward, .command = .navigation_jump_forward },
        .{ .context = .dashboard, .key_text = keys.dashboard_up, .command = .dashboard_move_up },
        .{ .context = .dashboard, .key_text = keys.dashboard_down, .command = .dashboard_move_down },
        .{ .context = .dashboard, .key_text = keys.dashboard_select, .command = .dashboard_select },
        .{ .context = .explorer, .key_text = keys.explorer_up, .command = .explorer_move_up },
        .{ .context = .explorer, .key_text = keys.explorer_down, .command = .explorer_move_down },
        .{ .context = .explorer, .key_text = keys.explorer_open, .command = .explorer_open_selected },
        .{ .context = .explorer, .key_text = keys.explorer_new_file, .command = .explorer_new_file },
        .{ .context = .explorer, .key_text = keys.explorer_rename, .command = .explorer_rename },
        .{ .context = .explorer, .key_text = keys.explorer_delete, .command = .explorer_delete },
        .{ .context = .normal, .key_text = keys.insert_mode, .command = .mode_insert },
        .{ .context = .normal, .key_text = keys.command_mode, .command = .mode_command },
        .{ .context = .dashboard, .key_text = keys.command_mode, .command = .mode_command },
        .{ .context = .normal, .key_text = keys.search_mode, .command = .mode_search },
        .{ .context = .explorer, .key_text = keys.search_mode, .command = .explorer_search_open },
        .{ .context = .insert, .key_text = keys.normal_mode, .command = .mode_normal },
        .{ .context = .normal, .key_text = keys.normal_mode, .command = .mode_normal },
        .{ .context = .command_line, .key_text = keys.normal_mode, .command = .command_cancel },
        .{ .context = .search, .key_text = keys.normal_mode, .command = .search_cancel },
        .{ .context = .global_search, .key_text = keys.normal_mode, .command = .global_search_cancel },
        .{ .context = .terminal, .key_text = keys.normal_mode, .command = .terminal_unfocus },
        .{ .context = .picker, .key_text = keys.normal_mode, .command = .picker_cancel },
        .{ .context = .prompt, .key_text = keys.normal_mode, .command = .prompt_cancel },
        .{ .context = .open_file_prompt, .key_text = keys.normal_mode, .command = .open_file_prompt_cancel },
        .{ .context = .save_confirmation, .key_text = keys.normal_mode, .command = .save_confirmation_cancel },
        .{ .context = .insert, .key_text = keys.insert_newline, .command = .editing_insert_newline },
        .{ .context = .insert, .key_text = keys.delete_back, .command = .editing_delete_back },
        .{ .context = .normal, .key_text = keys.delete_word_back, .command = .editing_delete_word_back },
        .{ .context = .insert, .key_text = keys.delete_word_back, .command = .editing_delete_word_back },
        .{ .context = .insert, .key_text = keys.indent, .command = .editing_indent },
        .{ .context = .command_line, .key_text = keys.indent, .command = .command_suggestion_next },
        .{ .context = .global_search, .key_text = keys.indent, .command = .global_search_select_next },
        .{ .context = .command_line, .key_text = keys.prompt_submit, .command = .command_execute },
        .{ .context = .search, .key_text = keys.prompt_submit, .command = .search_accept },
        .{ .context = .global_search, .key_text = keys.prompt_submit, .command = .global_search_accept },
        .{ .context = .picker, .key_text = keys.prompt_submit, .command = .picker_accept },
        .{ .context = .prompt, .key_text = keys.prompt_submit, .command = .prompt_submit },
        .{ .context = .open_file_prompt, .key_text = keys.prompt_submit, .command = .open_file_prompt_submit },
        .{ .context = .save_confirmation, .key_text = keys.prompt_submit, .command = .save_confirmation_discard },
        .{ .context = .command_line, .key_text = keys.prompt_backspace, .command = .command_backspace },
        .{ .context = .search, .key_text = keys.prompt_backspace, .command = .search_backspace },
        .{ .context = .global_search, .key_text = keys.prompt_backspace, .command = .global_search_backspace },
        .{ .context = .picker, .key_text = keys.prompt_backspace, .command = .picker_back },
        .{ .context = .prompt, .key_text = keys.prompt_backspace, .command = .prompt_backspace },
        .{ .context = .open_file_prompt, .key_text = keys.prompt_backspace, .command = .open_file_prompt_backspace },
        .{ .context = .explorer_search, .key_text = keys.prompt_backspace, .command = .explorer_search_backspace },
        .{ .context = .normal, .key_text = keys.save, .command = .file_write },
        .{ .context = .insert, .key_text = keys.save, .command = .file_write },
        .{ .context = .normal, .key_text = keys.undo, .command = .editing_undo },
        .{ .context = .insert, .key_text = keys.undo, .command = .editing_undo },
        .{ .context = .normal, .key_text = keys.redo, .command = .editing_redo },
        .{ .context = .insert, .key_text = keys.redo, .command = .editing_redo },
        .{ .context = .normal, .key_text = keys.select_all, .command = .editing_select_all },
        .{ .context = .insert, .key_text = keys.select_all, .command = .editing_select_all },
        .{ .context = .normal, .key_text = keys.copy, .command = .editing_copy },
        .{ .context = .insert, .key_text = keys.copy, .command = .editing_copy },
        .{ .context = .normal, .key_text = keys.cut, .command = .editing_cut },
        .{ .context = .insert, .key_text = keys.cut, .command = .editing_cut },
        .{ .context = .normal, .key_text = keys.paste, .command = .editing_paste },
        .{ .context = .insert, .key_text = keys.paste, .command = .editing_paste },
        .{ .context = .normal, .key_text = keys.duplicate_line, .command = .editing_duplicate_line },
        .{ .context = .insert, .key_text = keys.duplicate_line, .command = .editing_duplicate_line },
        .{ .context = .normal, .key_text = keys.delete_line, .command = .editing_delete_line },
        .{ .context = .insert, .key_text = keys.delete_line, .command = .editing_delete_line },
        .{ .context = .normal, .key_text = keys.add_cursor_above, .command = .editing_add_cursor_above },
        .{ .context = .insert, .key_text = keys.add_cursor_above, .command = .editing_add_cursor_above },
        .{ .context = .normal, .key_text = keys.add_cursor_below, .command = .editing_add_cursor_below },
        .{ .context = .insert, .key_text = keys.add_cursor_below, .command = .editing_add_cursor_below },
        .{ .context = .normal, .key_text = keys.move_up, .command = .navigation_move_up },
        .{ .context = .insert, .key_text = keys.move_up, .command = .navigation_move_up },
        .{ .context = .normal, .key_text = keys.move_down, .command = .navigation_move_down },
        .{ .context = .insert, .key_text = keys.move_down, .command = .navigation_move_down },
        .{ .context = .normal, .key_text = keys.move_left, .command = .navigation_move_left },
        .{ .context = .insert, .key_text = keys.move_left, .command = .navigation_move_left },
        .{ .context = .normal, .key_text = keys.move_right, .command = .navigation_move_right },
        .{ .context = .insert, .key_text = keys.move_right, .command = .navigation_move_right },
        .{ .context = .normal, .key_text = keys.line_start, .command = .navigation_line_start },
        .{ .context = .insert, .key_text = keys.line_start, .command = .navigation_line_start },
        .{ .context = .normal, .key_text = keys.line_end, .command = .navigation_line_end },
        .{ .context = .insert, .key_text = keys.line_end, .command = .navigation_line_end },
        .{ .context = .normal, .key_text = keys.word_left, .command = .navigation_word_left },
        .{ .context = .insert, .key_text = keys.word_left, .command = .navigation_word_left },
        .{ .context = .normal, .key_text = keys.word_right, .command = .navigation_word_right },
        .{ .context = .insert, .key_text = keys.word_right, .command = .navigation_word_right },
        .{ .context = .search, .key_text = keys.search_next, .command = .search_next_match },
        .{ .context = .search, .key_text = keys.search_previous, .command = .search_previous_match },
        .{ .context = .normal, .key_text = keys.completion_auto_trigger, .command = .completion_auto_trigger },
        .{ .context = .insert, .key_text = keys.completion_auto_trigger, .command = .completion_auto_trigger },
        .{ .context = .normal, .key_text = keys.completion_trigger, .command = .completion_trigger },
        .{ .context = .insert, .key_text = keys.completion_trigger, .command = .completion_trigger },
        .{ .context = .completion, .key_text = keys.completion_next, .command = .completion_next },
        .{ .context = .completion, .key_text = keys.completion_previous, .command = .completion_previous },
        .{ .context = .completion, .key_text = keys.completion_accept, .command = .completion_accept },
        .{ .context = .completion, .key_text = keys.completion_cancel, .command = .completion_cancel },
    };

    for (cases) |case| {
        try std.testing.expect(hasDefaultBinding(
            case.context,
            KeySequence.fromEvent(terminal.parseKeyChord(case.key_text)),
            case.command,
        ));
    }
}
